...
- **확인 카드**: 유료 생성 전에 만들 것·방향·문구·사용 도구·비용(실제 크레딧과 잔액)을 한 장으로 보여줍니다. "이대로 만들기"를 골라야 생성이 시작됩니다. 영상은 기준 이미지와 영상, 두 번 확인합니다.
...
Chany's Studio 2.9.0은 두 축, 하나의 전문 크리에이티브 디렉션 계층과 하나의 공통 미디어 실행 루프를 함께 사용합니다.
