...
- **레퍼런스 자동 추천**: 제품 사진을 올리면 제품의 모양·색·재질에 어울리는 레퍼런스를 찾아 보여주고 한 장을 추천합니다. 원본 제품을 잘라 배경에 붙이는 것이 아니라, 같은 제품을 레퍼런스의 촬영 방식으로 새로 찍듯 만듭니다. 제품의 실제 형태·재질·색·라벨은 지키고 촬영 각도·배치·화면 내 크기·여백·공간감은 레퍼런스에 맞춥니다. “배경만 교체해줘”처럼 범위를 지정했을 때는 기존 구도를 유지합니다.
...
| 이 사진처럼 내 제품으로 | 같은 제품을 참고 사진의 각도·배치·빛으로 새로 촬영하듯 제작. 원본 사진의 구도는 자동 고정하지 않음 |
