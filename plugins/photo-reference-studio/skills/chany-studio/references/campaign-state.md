...
- Attribute any specialist or external review result with the producer's name, reviewed-object version, sources and dates, findings, and unresolved questions; never collapse them into untraceable campaign truth.
